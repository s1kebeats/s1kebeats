<template>
  <div
    ...
    tabindex="0"
    class="focus:outline-none overflow-hidden relative cursor-pointer w-[45px] h-[45px] mr-[.40px] rounded-full bg-white flex items-center justify-center text-[12px] text-black font-semibold"
