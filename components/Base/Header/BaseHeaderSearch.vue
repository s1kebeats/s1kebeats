<template>
    <div class="h-[30px] rounded-full flex-1 border-[1px] max-w-[600px] px-3 flex gap-2 items-center cursor-pointer" >
        <img src="~/assets/images/search.svg" class="w-[18px]" alt="Search" @click="submitSearchQuery">
        <input ref="searchInput" type="text" class="flex-1 h-[20px] focus:outline-none text-sm" placeholder="Find your sound" :value="searchQuery.query" @input="searchQueryInput">
...
const searchOptions = [
    {id: 1, value: 'beats', text: 'Beats', default: true},
    {id: 2, value: 'authors', text: 'Authors', default: false},
]
